...
function TopRankCard() {
    return (
        ...
        <div className="row mb-3" style={{justifyContent: "center"}}>
                ...
                <div className="row mt-5 p-2" style={{background: "#fffdec", boxShadow: " 0px 4px 4px rgba(0, 0, 0, 0.25)", borderRadius: "2.85rem"}}>
                    ...
                    <div className="col-md-7">
                        ...
                        <br/>
                        <span style={{float:'right', fontSize:"1.8rem",fontWeight: "700", fontFamily: "Poppins",color:"#6a6a6a"}}>Points Earned : 200</span>
                        </p>
