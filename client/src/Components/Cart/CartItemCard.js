            ...
            <div className="col-md-6">
                ...
                <div className="col-md-2" style={{alignSelf: "center"}}>
                    <div className="row" style={{background: "#dddddd"}}>
                        <div className="col-md-2 text-center" style={{alignSelf: "center"}}>
                        <span style={{fontFamily: "Poppins",fontWeight: "500"}}>+</span>
                        </div>
                        <div className="col-md-7">
                            <input style={{width: "100%",alignSelf: "center", textAlign: "center"}} value="1">
                            </input>
                        </div>
                        <div className="col-md-2 text-center" style={{alignSelf: "center", padding: "0"}}>
